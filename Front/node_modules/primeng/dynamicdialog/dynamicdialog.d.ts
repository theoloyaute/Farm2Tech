...
export declare class DynamicDialogComponent implements AfterViewInit, OnDestroy {
    ...
    set style(value: any);
    get parent(): Element;
    constructor(document: Document, platformId: any, componentFactoryResolver: ComponentFactoryResolver, cd: ChangeDetectorRef, renderer: Renderer2, config: DynamicDialogConfig, dialogRef: DynamicDialogRef, zone: NgZone, primeNGConfig: PrimeNGConfig);
