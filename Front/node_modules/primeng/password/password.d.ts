import { AfterContentInit, ChangeDetectorRef, DoCheck, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, PipeTransform, QueryList, TemplateRef } from '@angular/core';
...
export declare class Password implements AfterContentInit, OnInit {
    ...
    toggleIconClass(unmasked: boolean): "pi pi-eye-slash" | "pi pi-eye";
...
export declare class PasswordModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<PasswordModule, [typeof PasswordDirective, typeof Password, typeof MapperPipe], [typeof i1.CommonModule, typeof i2.InputTextModule], [typeof PasswordDirective, typeof Password, typeof i3.SharedModule]>;
